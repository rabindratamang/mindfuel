      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 z-50 lg:hidden flex flex-col"
          >
            {/* Header */}
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 p-4">
              <MobileSidebarLink href="/logout" icon={LogOut} label="Logout" isActive={false} onClick={onClose} />
            </div>
          </motion.div>
        </>
      )}
