...
class MoodAnalyzerMasterAgent:
    def __init__(self):
        ...
        self.agent = create_react_agent(
                        ...
                        prompt=(
                            ...
                            For youtube and spotify, you will use the search_youtube_videos and search_spotify_playlists tools respectively strictly for the fields "videos" and "playlist".
                            ...
                            "recommendations": {{
                                ...
                                "youtube": {{
                                    ...
                                    "mood": "string" // target mood for content,
                                    "num_videos": number // exactly 6 videos,
                                    "videos": [{{ // use search_youtube_videos tool to get the videos, IMPORTANT: do only one tool call strictly for this field, also directly use the tool call response for this field, do not parse the response yourself
                                        "video_id": "string",
                                        "video_url": "string",
                                        "title": "string",
                                        "description": "string",
    ...
    async def run(self, user_input: str, user_id: str = None, context: str = None, save_to_db: bool = True) -> Dict[str, Any]:
            try:
                ...
                return {"error": "Unknown content format from mood analyzer."}
